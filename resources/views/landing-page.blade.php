...
<body>
    ...
    <div class="d-flex" style=" padding-top:7rem; padding-bottom: 10rem;" id="section2">
        <div class="container">
                ...
                <div class="col-6">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <a onclick="setRole2()" id="buttonDrp" href="/register" class="btn btn-primary2" style="font-weight: 600; font-size:18px; padding-left:2rem; padding-right:2rem;">
                                Daftar
                ...
                <div class="col-6">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <a onclick="setRole1()" id="buttonSpl" href="/register" class="btn btn-primary2" style="font-weight: 600; font-size:18px; padding-left:2rem; padding-right:2rem;">
                                Daftar
                                <i class="fa fa-angle-right" aria-hidden="true" style=" margin-left:0.5rem;"></i>
                            </a>
                        </div>
